...
@AIName("IDBattleChange_Polymorph_Wi")
public class IDBattleChange_Polymorph_WiAI2 extends NpcAI2
{
	@Override
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (dialogId == 10000) {
			switch (getNpcId()) {
			    case 656680: //IDBattleChange_Polymorph_Wi_NPC_Li.
				    if (player.getCommonData().getRace() == Race.ELYOS) {
						...
						player.getSkillList().addSkill(player, 5205, 1);
						player.getSkillList().addSkill(player, 5208, 1);
						player.getSkillList().addSkill(player, 5320, 1);
						player.getSkillList().addSkill(player, 5213, 1);
						player.getSkillList().addSkill(player, 5211, 1);
						//Kn
					    ...
					    SkillEngine.getInstance().applyEffectDirectly(20311, player, player, 1800000 * 1);
					}
			    break;
				case 656683: //IDBattleChange_Polymorph_Wi_NPC_Da.
				    if (player.getCommonData().getRace() == Race.ASMODIANS) {
						...
						player.getSkillList().addSkill(player, 5205, 1);
						player.getSkillList().addSkill(player, 5208, 1);
						player.getSkillList().addSkill(player, 5321, 1);
						player.getSkillList().addSkill(player, 5316, 1);
						player.getSkillList().addSkill(player, 5211, 1);
						//Kn
						SkillLearnService.removeSkill(player, 5181);
						SkillLearnService.removeSkill(player, 5187);
						...
						SkillLearnService.removeSkill(player, 5249);
						SkillLearnService.removeSkill(player, 5250);
					    SkillEngine.getInstance().applyEffectDirectly(20317, player, player, 1800000 * 1);
					}
			    break;
			}
		}
