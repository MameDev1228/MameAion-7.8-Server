...
public class QUEST_Q73804 extends QuestHandler
{
	private final static int questId = 73804;
	private final static int[] npcs = {820921};
	
	private final static int[] DF4_Hun_Big = {662868, 662869};
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 1) {
				...
				switch (targetId) {
					...
					case 662867:
						if (var1 < 0) {
							return defaultOnKillEvent(env, DF4_Hunt_Small, 0, 0, 1);
						} else if (var1 == 0) {
							if (var2 == 1) {
								qs.setQuestVar(2);
								...
								return defaultOnKillEvent(env, DF4_Hunt_Small, 0, 1, 1);
							}
						}
					break;
					case 662868:
					case 662869:
						if (var2 < 0) {
							return defaultOnKillEvent(env, DF4_Hun_Big, 0, 0, 2);
						} else if (var2 == 0) {
							if (var1 == 1) {
								qs.setQuestVar(2);
								updateQuestStatus(env);
								...
								return defaultOnKillEvent(env, DF4_Hun_Big, 0, 1, 2);
							}
						}
					break;
				}
