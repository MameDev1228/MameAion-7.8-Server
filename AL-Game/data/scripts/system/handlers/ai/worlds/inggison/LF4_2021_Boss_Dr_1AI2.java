...
@AIName("LF4_2021_Boss_Dr_1")
public class LF4_2021_Boss_Dr_1AI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc siegeGate1 = getPosition().getWorldMapInstance().getNpc(257494);
				Npc siegeGate2 = getPosition().getWorldMapInstance().getNpc(257541);
