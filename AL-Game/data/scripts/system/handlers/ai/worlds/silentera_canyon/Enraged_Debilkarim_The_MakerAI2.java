...
@AIName("Nepilim_Boss_80")
public class Enraged_Debilkarim_The_MakerAI2 extends AggressiveNpcAI2
{
	...
	private void protectionOfAion() {
		...
		//Kneel before me!
		sendMsg(1500042, getObjectId(), false, 10000);
		ThreadPoolManager.getInstance().schedule(new Runnable() {
			@Override
			public void run() {
				if (getPosition().getWorldMapInstance().getNpc(282469) == null) {
					rndSpawn(282469, 6);
				}
			}
		}, 5500);
    ...
    protected void handleBackHome() {
		...
		killNpc(instance.getNpcs(282469));
    }
