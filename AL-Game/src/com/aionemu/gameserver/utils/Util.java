...
public class Util {
	...
	public static String convertName(String name) {
		// MameAion75: preserve player/legion names exactly as entered.
		// Older sources normalized "testNAME" to "Testname", which breaks Japanese
		// names and intentionally mixed-case names on 7.x clients.
