...
public class QUEST_Q63825 extends QuestHandler
{
	private final static int questId = 63825;
	...
	public void register() {
		...
		qe.registerQuestNpc(840019).addOnTalkEvent(questId);
		qe.registerOnEnterZone(ZoneName.get("BESPERA_PORT_302820000"), questId);
		qe.registerOnEnterZone(ZoneName.get("SEVENTH_ALTAR_302820000"), questId);
		...
		qe.registerOnEnterZone(ZoneName.get("IDF8_DRAGON_ALTAR_302820000"), questId);
		...
		qe.registerOnEnterZone(ZoneName.get("TENTH_ALTAR_OPEN_SPACE_302820000"), questId);
    ...
    public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
        Player player = env.getPlayer();
        QuestState qs = player.getQuestStateList().getQuestState(questId);
		if (zoneName == ZoneName.get("IDF8_DRAGON_ALTAR_302820000")) {
			...
			if (zoneName == ZoneName.get("SEVENTH_ALTAR_302820000")) {
				if (var == 0) {
					qs.setQuestVar(1);
			...
			} if (zoneName == ZoneName.get("TENTH_ALTAR_OPEN_SPACE_302820000")) {
				if (var == 2) {
					qs.setQuestVar(3);
					updateQuestStatus(env);
					return true;
