...
@AIName("DF4_3011_Boss_Li_1")
public class DF4_3011_Boss_Li_1AI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc siegeGate1 = getPosition().getWorldMapInstance().getNpc(257792);
				Npc siegeGate2 = getPosition().getWorldMapInstance().getNpc(257839);
