...
@AIName("Asmodian_Guardian_Deity_General")
public class Asmodian_Guardian_Deity_GeneralAI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc gateProtection1 = getPosition().getWorldMapInstance().getNpc(835764);
				Npc gateProtection2 = getPosition().getWorldMapInstance().getNpc(835765);
				Npc gateProtection3 = getPosition().getWorldMapInstance().getNpc(835766);
				Npc gateProtection4 = getPosition().getWorldMapInstance().getNpc(835767);
				Npc gateProtection5 = getPosition().getWorldMapInstance().getNpc(835768);
