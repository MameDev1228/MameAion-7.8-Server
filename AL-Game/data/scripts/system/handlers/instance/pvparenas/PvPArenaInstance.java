...
public class PvPArenaInstance extends GeneralInstanceHandler
{
	...
	private int getNpcBonus(int npcId) {
		switch (npcId) {
			...
			case 654948: //Red Sand Brax.
			case 654949: //Red Sand Tog.
	...
	protected void reward() {
		for (Player player : instance.getPlayersInside()) {
			...
			if (!reward.isRewarded()) {
				...
				int kinah = reward.getBasicKinah() + reward.getRankingKinah() + reward.getScoreKinah();
				if (kinah != 0) {
					ItemService.addItem(player, 182400001, kinah);
				}
			}
	...
	public void handleUseItemFinish(Player player, Npc npc) {
		switch(npc.getNpcId()) {
			...
			case 701170: //Plaza Flame Thrower.
				...
				spawn(702405, 1871.4725f, 1699.5228f, 303.03930f, (byte) 104);
			break;
			case 701171: //Plaza Flame Thrower.
			    despawnNpc(npc);
				spawn(702405, 1886.8333f, 1738.3987f, 302.53740f, (byte) 3);
				spawn(702405, 1876.5596f, 1761.9902f, 302.65820f, (byte) 14);
			break;
			case 701172: //Plaza Flame Thrower.
			    despawnNpc(npc);
				spawn(702405, 1837.2420f, 1776.3717f, 302.76150f, (byte) 32);
			...
			*/
			...
			case 218795:
				switch (Rnd.get(1, 5)) {
					case 1:
					    ItemService.addItem(player, 152012768, 5); //Genesis Crystal.
					break;
					case 2:
					    ItemService.addItem(player, 152080000, 5); //Legendary Ridium.
					break;
					case 3:
					    ItemService.addItem(player, 152080001, 5); //Ultimate Ridium.
					break;
					case 4:
					    ItemService.addItem(player, 152080002, 5); //Fighting Spirit Fragment.
					break;
					case 5:
					    ItemService.addItem(player, 152080003, 5); //Ancient Kibrium.
					break;
				}
				despawnNpc(npc);
			break;
