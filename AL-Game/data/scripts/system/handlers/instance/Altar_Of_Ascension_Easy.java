...
@InstanceID(302820000)
public class Altar_Of_Ascension_Easy extends GeneralInstanceHandler
{
    ...
    public void onEnterInstance(final Player player) {
		...
		if (player.getRace() == Race.ELYOS) {
			...
			ClassChangeService.onUpdateQuest63820(player);
			ClassChangeService.onUpdateQuest63840(player);
		} else {
			ClassChangeService.onUpdateGuide73802(player);
			ClassChangeService.onUpdateQuest73820(player);
			ClassChangeService.onUpdateQuest73840(player);
		} if (spawnRace == null) {
    ...
    public void onInstanceCreate(WorldMapInstance instance) {
		...
		//Complete the raid as quickly as possible to obtain an additional Altar of Ascension (Easy) Reward Box.
		sendMsgByRace(1405940, Race.PC_ALL, 17000);
		spawn(858785, 2876.2680f, 2261.586f, 720.6205f, (byte) 105); //Weakened Mortasha.
		...
		switch (Rnd.get(1, 6)) {
			case 1:
				...
				spawn(656832, 2250.3306f, 2018.016f, 737.3909f, (byte) 112);
			break;
			case 2:
			    //The Smuggler Shukirukin will soon appear.
				sendMsgByRace(1404596, Race.PC_ALL, 30000);
				spawn(656833, 2278.0552f, 1955.4362f, 737.3958f, (byte) 18);
			break;
			case 3:
			    //The Great Smuggler Shukirukin will soon appear.
				sendMsgByRace(1404595, Race.PC_ALL, 30000);
				spawn(656832, 2319.767f, 1954.7932f, 737.394f, (byte) 42);
			break;
			case 4:
			    //The Smuggler Shukirukin will soon appear.
				sendMsgByRace(1404596, Race.PC_ALL, 30000);
				spawn(656833, 2331.3083f, 2004.8306f, 737.3943f, (byte) 70);
			break;
			case 5:
			    //The Great Smuggler Shukirukin will soon appear.
				sendMsgByRace(1404595, Race.PC_ALL, 30000);
				spawn(656832, 2279.8596f, 2031.3428f, 737.393f, (byte) 98);
			break;
			case 6:
			break;
		}
    ...
    public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			case 858787: //Weakened Mortasha [1st Boss].
			    despawnNpc(npc);
				...
				spawn(858788, 2293.6052f, 1988.4974f, 737.4075f, (byte) 114); //Weakened Mortasha [Final Boss].
			break;
			case 858788: //Weakened Mortasha [Final Boss].
