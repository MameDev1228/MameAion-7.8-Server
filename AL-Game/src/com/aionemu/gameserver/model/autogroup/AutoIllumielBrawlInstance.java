...
import com.aionemu.gameserver.services.instance.IllumielBrawlService;
...
public class AutoIllumielBrawlInstance extends AutoInstance
{
	@Override
	...
	public void onPressEnter(Player player) {
		...
		IllumielBrawlService.getInstance().addCoolDown(player);
		((IllumielBattlefieldReward) instance.getInstanceHandler().getInstanceReward()).portToPosition(player);
	}
