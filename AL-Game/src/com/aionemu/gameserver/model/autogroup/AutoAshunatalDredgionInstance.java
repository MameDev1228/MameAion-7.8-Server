...
import com.aionemu.gameserver.services.instance.AshunatalService;
...
public class AutoAshunatalDredgionInstance extends AutoInstance
{
	@Override
	...
	public void onPressEnter(Player player) {
		...
		AshunatalService.getInstance().addCoolDown(player);
