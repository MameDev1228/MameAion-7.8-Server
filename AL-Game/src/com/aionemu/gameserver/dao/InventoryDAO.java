...
public abstract class InventoryDAO implements IDFactoryAwareDAO {
	...
	public abstract void loadItemRndBonus(Item item);
	public abstract void saveItemRndBonus(Item item, ItemRndBonus bonus);
	public abstract void updateItemRndBonus(Item item, ItemRndBonus bonus);
	public abstract void deleteItemRndBonus(Item item);
