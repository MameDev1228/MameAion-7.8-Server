		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			case 282291: //Surkana Feeder.
				...
				instance.doOnAllPlayers(new Visitor<Player>() {
				    @Override
				    public void visit(Player player) {
						SkillEngine.getInstance().applyEffectDirectly(19523, player, player, 120000 * 1); //Surkana Overload.
				    }
			    });
			break;
			/**
			...
			case 655511: //Dalia Charlands.
				...
				spawn(703052, 392.0000f, 543.0000f, 318.0000f, (byte) 18); //Windstream A.
				spawn(703054, 392.0000f, 543.0000f, 318.0000f, (byte) 18); //Windstream B.
			...
			*/
			case 655521: //Captain Murugan.
				...
				spawn(703056, 392.0000f, 543.0000f, 318.0000f, (byte) 18); //Windstream C
				spawn(703058, 392.0000f, 543.0000f, 318.0000f, (byte) 18); //Windstream D
