...
@InstanceID(302690000)
public class Benirunerk_Estate_Easy extends GeneralInstanceHandler
{
	...
	public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			...
			case 858684: //소형기갑 VR-04.
				...
				spawn(858685, 533.0000f, 742.0000f, 179.0000f, (byte) 98); //특대기갑 SVR-07.
				instance.doOnAllPlayers(new Visitor<Player>() {
					@Override
					public void visit(Player player) {
						if (player.isOnline()) {
			...
			break;
			case 858685: //특대기갑 SVR-07.
			    despawnNpc(npc);
				killNpc(getNpcs(858515));
				spawn(839569, 544.0000f, 747.0000f, 180.0000f, (byte) 0); //Benirunerk's Estate Treasure Box.
