...
public class PlayerGroupService
{
    ...
    public static final Map<Integer, PlayerGroup> groups = new ConcurrentHashMap<Integer, PlayerGroup>();
    ...
    public static final void addPlayerToGroup(PlayerGroup group, Player invited) {
        ...
        for(Player pl : group.getMembers()) {
            PlayerGroupService.checkGroupBonus(pl, false);
        }
        group.setBuffId(group.getBuffId() + 1);
        for(Player pl : group.getMembers()) {
            PlayerGroupService.checkGroupBonus(pl, true);
        }
    }
