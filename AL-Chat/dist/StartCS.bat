...
TITLE MameAion 7.8.0 - Chat Server / チャットサーバー
:START
CLS
echo ================================================================================
echo   MameAion 7.8.0  Chat Server / チャットサーバー
...
ECHO.
ECHO [起動] MameAion 7.8.0 Chat Server / %MODE%
"%JAVA_EXE%" %JDK25_COMPAT_OPTS% %ENCODING_OPTS% %JAVA_OPTS% -cp "./libs/*;AL-Chat.jar" com.aionemu.chatserver.ChatServer
...
:ERROR
ECHO.
ECHO [停止] Chat Server が異常終了しました。
ECHO.
PAUSE
EXIT /b 1
:END
ECHO.
ECHO [停止] Chat Server は正常終了しました。
ECHO.
PAUSE
EXIT /b 0
