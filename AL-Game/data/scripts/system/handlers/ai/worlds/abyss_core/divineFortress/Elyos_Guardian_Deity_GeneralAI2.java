...
@AIName("Elyos_Guardian_Deity_General")
public class Elyos_Guardian_Deity_GeneralAI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc gateProtection1 = getPosition().getWorldMapInstance().getNpc(835759);
				Npc gateProtection2 = getPosition().getWorldMapInstance().getNpc(835760);
				Npc gateProtection3 = getPosition().getWorldMapInstance().getNpc(835761);
				Npc gateProtection4 = getPosition().getWorldMapInstance().getNpc(835762);
				Npc gateProtection5 = getPosition().getWorldMapInstance().getNpc(835763);
