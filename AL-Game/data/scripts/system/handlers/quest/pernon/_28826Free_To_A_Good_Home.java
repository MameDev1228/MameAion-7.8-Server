...
{
	private final static int questId = 28826;
	...
	public void register() {
		qe.registerQuestNpc(830521).addOnQuestStart(questId); //Legirunerk.
		...
		qe.registerQuestNpc(830521).addOnTalkEvent(questId); //Legirunerk.
