...
public class IllumielBattlefieldPlayerReward extends InstancePlayerReward
{
    ...
    private int legendaryRidium;
	private int warriorMedalBundle;
    private int battlefieldMinionBundle;
	private int battlefieldPvPEnchantmentStoneBundle;
    private float rewardCount;
	private InstanceBuff boostMorale;
	
    public IllumielBattlefieldPlayerReward(Integer object, int timeBonus, byte buffId, Race race) {
        super(object);
    ...
    public int getWarriorMedalBundle() {
        return warriorMedalBundle;
    }
	public int getLegendaryRidium() {
        return legendaryRidium;
    }
    public int getBattlefieldMinionBundle() {
        return battlefieldMinionBundle;
    }
	public int getBattlefieldPvPEnchantmentStoneBundle() {
        return battlefieldPvPEnchantmentStoneBundle;
    }
	
    public void setWarriorMedalBundle(int reward) {
        this.warriorMedalBundle = reward;
    }
	public void setLegendaryRidium(int reward) {
        this.legendaryRidium = reward;
    }
    public void setBattlefieldMinionBundle(int reward) {
        this.battlefieldMinionBundle = reward;
    }
	public void setBattlefieldPvPEnchantmentStoneBundle(int reward) {
        this.battlefieldPvPEnchantmentStoneBundle = reward;
    }
