...
@AIName("Disorienting_Fog")
public class Disorienting_FogAI2 extends NpcAI2
{
	@Override
	...
	private void checkDistance(Creature creature) {
		...
		int skill = 0;
		switch (owner) {
			case 858182: //Disorienting Fog.
				skill = 20559;
			break;
		} if (creature instanceof Player) {
			if (getNpcId() == 858182 && MathUtil.isIn3dRangeLimited(getOwner(), creature, 1, 8)) {
