...
public class QUEST_Q60300 extends QuestHandler
{
	private final static int questId = 60300;
	private final static int[] npcs = {798408, 798926, 820064};
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        ...
        if (player == null || env == null) {
		    ...
		    player.getLevel() >= 76 && player.getLevel() <= 80) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.START) {
            if (targetId == 798408) {
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						TeleportService2.teleportTo(env.getPlayer(), 210050000, 1440.0000f, 366.0000f, 557.0000f, (byte) 86);
            ...
            if (targetId == 798926) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    ...
                    int[] inggisonMission = {60301, 60302, 60303, 60304, 60305, 60306, 60307, 60309};
