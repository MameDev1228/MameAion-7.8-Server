...
{
	private final static int questId = 18826;
	...
	public void register() {
		qe.registerQuestNpc(830520).addOnQuestStart(questId); //Gomurunerk.
		...
		qe.registerQuestNpc(830520).addOnTalkEvent(questId); //Gomurunerk.
