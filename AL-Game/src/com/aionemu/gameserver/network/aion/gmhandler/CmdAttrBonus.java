...
public class CmdAttrBonus extends AbstractGMHandler implements StatOwner {
    ...
    enum AttrBonusAction {
        ...
        AROPENAREIAL("AROPENAREIAL", StatEnum.BIND_RESISTANCE),
        ARPARALYZE("ARPARALYZE", StatEnum.PARALYZE_RESISTANCE),
        ARPERIFICATION("ARPERIFICATION", StatEnum.PETRIFICATION_RESISTANCE),
        ...
        OPENAREIAL_ARP("OPENAREIAL ARP", StatEnum.OPENAERIAL_RESISTANCE_PENETRATION),
        PARALYZE_ARP("PARALYZE ARP", StatEnum.PARALYZE_RESISTANCE_PENETRATION),
        PARRY("PARRY", StatEnum.PARRY),
        PERIFICATION_ARP("PERIFICATION ARP", StatEnum.BIND_RESISTANCE_PENETRATION),
        ...
        public void apply(Stat2 stat) {
            switch (this.stat) {
                ...
                case STUN_RESISTANCE_PENETRATION:
                    ...
                    break;
                case BIND_RESISTANCE_PENETRATION:
                ...
                case STAGGER_RESISTANCE_PENETRATION:
                    ...
                    break;
                case OPENAERIAL_RESISTANCE_PENETRATION:
