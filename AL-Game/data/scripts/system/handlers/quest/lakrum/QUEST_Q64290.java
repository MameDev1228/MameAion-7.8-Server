...
public class QUEST_Q64290 extends QuestHandler
{
	private final static int questId = 64290;
	...
	public void register() {
		qe.registerQuestNpc(840022).addOnQuestStart(questId);
		qe.registerQuestNpc(840022).addOnTalkEvent(questId);
    ...
    public boolean onDialogEvent(final QuestEnv env) {
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			...
			if (targetId == 840034 || targetId == 840035 || targetId == 840036 || targetId == 840037 ||
				targetId == 840038 || targetId == 840039 || targetId == 840040 || targetId == 840041 || targetId == 840042) {
                switch (env.getDialog()) {
                    case START_DIALOG: {
                        if (var == 0) {
