...
@InstanceID(300920000)
public class IDCatacombs_Rudra_E extends GeneralInstanceHandler
{
    ...
    public void onDropRegistered(Npc npc) {
		...
		switch (npcId) {
			case 840737: //IDCatacombs_Rudra_E_Treasure_Box.
	...
	public void onEnterInstance(final Player player) {
		...
		if (player.getRace() == Race.ELYOS) {
			ClassChangeService.onUpdateQuest64400(player);
		} else {
			ClassChangeService.onUpdateQuest74400(player);
		}
    ...
    public void onDie(Npc npc) {
		...
		switch (npc.getObjectTemplate().getTemplateId()) {
			case 858988: //BIDCatacombs_Rudra_80_Ah_Easy.
				despawnNpc(npc);
				killNpc(getNpcs(858935));
				killNpc(getNpcs(858936));
				spawn(730287, 860.7437f, 1343.9053f, 223.7233f, (byte) 76); //Rift Orb.
				spawn(840737, 840.7994f, 1321.7267f, 223.6657f, (byte) 78); //IDCatacombs_Rudra_E_Treasure_Box.
			break;
			case 858989: //BIDCatacombs_DrakanMonkBossNmd_80_Ah_Easy.
				//The Seal Protector has fallen. The Rift Orb shines while the seal weakens.
				sendMsgByRace(1400480, Race.PC_ALL, 3000);
				spawn(858988, 850.39905f, 1332.6586f, 223.7155f, (byte) 77); //BIDCatacombs_Rudra_80_Ah_Easy.
				spawn(730276, 1423.0000f, 1463.0000f, 311.0000f, (byte) 0, 426); //Prison Of Ice Gate.
			break;
			case 858990: //BIDCatacombs_DrakanFiNmd_80_Ah_Easy.
