...
public class QUEST_Q70300 extends QuestHandler
{
	private final static int questId = 70300;
	private final static int[] npcs = {798409, 799225, 806835};
		...
		if (qs == null || qs.getStatus() == QuestStatus.START) {
            ...
            if (targetId == 799225) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    ...
                    int[] gelkmarosMission = {70301, 70302, 70303, 70304, 70305, 70306, 70307, 70309};
