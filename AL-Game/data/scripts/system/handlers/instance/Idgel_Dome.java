...
public class Idgel_Dome extends GeneralInstanceHandler
{
    ...
    protected void startInstanceTask() {
		...
		idgelTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                if (!idgelDomeReward.isRewarded()) {
				    openFirstDoors();
					spawn(857985, 251.25659f, 291.03445f, 89.302925f, (byte) 97); //Ide Explosion.
		...
		idgelTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                sp(654750, 266.579f, 257.436f, 85.81963f, (byte) 46, 0); //Destroyer Kunax.
				sp(654751, 250.67055f, 257.33798f, 85.81963f, (byte) 62, 0); //Sheban Elite Stalwart.
				sp(654752, 265.60724f, 272.637f, 85.81963f, (byte) 36, 0); //Sheban Elite Sniper.
				sp(654753, 263.66858f, 245.04124f, 85.81963f, (byte) 101, 0); //Sheban Elite Marauder.
				sp(654754, 278.0694f, 262.5485f, 85.81963f, (byte) 2, 0); //Sheban Elite Medic.
            }
        }, 600000));
		idgelTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
    ...
    protected void stopInstance(Race race) {
        stopInstanceTask();
		despawnNpcs(instance.getNpcs(857985)); //Ide Explosion.
	...
	public void sendPreparingPacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(6, getTime(), idgelDomeReward, instance.getPlayersInside(), true));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(3, getTime(), idgelDomeReward, player.getObjectId(), 0, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(7, getTime(), idgelDomeReward, instance.getPlayersInside(), true));
            }
        });
	}
	public void sendScoreTypePacket() {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player player) {
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(2, getTime(), idgelDomeReward, player.getObjectId()));
	...
	public void sendRewardPacket() {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player player) {
            	...
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(7, getTime(), idgelDomeReward, instance.getPlayersInside(), true));
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(5, getTime(), idgelDomeReward, player.getObjectId()));
            }
        });
    }
	...
	public void sendNpcScorePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(11, getTime(), idgelDomeReward, player.getObjectId()));
            }
        });
    }
	public void sendPlayerLeavePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(8, getTime(), idgelDomeReward, player.getObjectId()));
            }
        });
    }
	public void sendPlayerDiePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(4, getTime(), idgelDomeReward, player.getObjectId(), 60, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(3, getTime(), idgelDomeReward, player.getObjectId(), 60, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(7, getTime(), idgelDomeReward, instance.getPlayersInside(), true));
            }
        });
    }
	public void sendPlayerRevivedPacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(4, getTime(), idgelDomeReward, player.getObjectId(), 0, player.getRace().getRaceId()));
            }
        });
    }
	...
	public void onDie(Npc npc) {
        ...
        if (mostPlayerDamage == null) {
		    ...
		    case 654746: //Sheban Intelligence Unit Ridgeblade.
            case 654747: //Sheban Intelligence Unit Hunter.
            case 654748: //Sheban Intelligence Unit Mongrel.
            case 654749: //Sheban Intelligence Unit Stitch.
                score += 120;
				despawnNpc(npc);
            break;
			case 654751: //Sheban Elite Stalwart.
            case 654752: //Sheban Elite Sniper.
            case 654753: //Sheban Elite Marauder.
            case 654754: //Sheban Elite Medic.
                score += 200;
				despawnNpc(npc);
            break;
			case 654750: //Destroyer Kunax.
                score += 6000;
