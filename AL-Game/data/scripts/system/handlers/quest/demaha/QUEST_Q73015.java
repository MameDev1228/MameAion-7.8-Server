...
public class QUEST_Q73015 extends QuestHandler
{
	private final static int questId = 73015;
	...
	public void register() {
		qe.registerQuestNpc(820483).addOnQuestStart(questId);
    ...
    public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            int var = qs.getQuestVarById(0);
			if (zoneName == ZoneName.get("LDF8_SENSORY_AREA_B_Q63015_800060000")) {
				if (var == 0) {
					qs.setQuestVar(1);
			...
			} else if (zoneName == ZoneName.get("LDF8_SENSORY_AREA_A_Q63015_800060000")) {
				if (var == 2) {
					qs.setQuestVar(3);
					updateQuestStatus(env);
