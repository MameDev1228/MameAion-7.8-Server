...
public class Kamar_Battlefield extends GeneralInstanceHandler
{
    ...
    protected void startInstanceTask() {
		...
		kamarTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
				...
				sp(701902, 1262.3992f, 1609.1414f, 585.9064f, (byte) 53, 0);
				//Kamar Cannon Flag.
				sp(801960, 1364.5979f, 1467.5867f, 599.7256f, (byte) 104, 0);
				sp(801961, 1262.3992f, 1609.1414f, 585.9064f, (byte) 53, 0);
            }
        }, 110000));
		kamarTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
		...
		kamarTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                switch (Rnd.get(1, 3)) {
                    case 1:
                        sp(233321, 1453.4650f, 1347.8022f, 606.1285f, (byte) 42, 0); //General Varga.
						sp(801956, 1453.4650f, 1347.8022f, 606.1285f, (byte) 42, 0); //General Varga Flag.
                    ...
                    case 2:
						...
						sp(233325, 1418.1080f, 1610.5255f, 599.9493f, (byte) 71, 0); //Varga Assault Commander.
                    break;
                    case 3:
	...
	public void sendPreparingPacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(6, getTime(), kamarBattlefieldReward, instance.getPlayersInside(), true));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(3, getTime(), kamarBattlefieldReward, player.getObjectId(), 0, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(7, getTime(), kamarBattlefieldReward, instance.getPlayersInside(), true));
            }
        });
	}
	public void sendScoreTypePacket() {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player player) {
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(2, getTime(), kamarBattlefieldReward, player.getObjectId()));
	...
	public void sendRewardPacket() {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player player) {
            	...
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(7, getTime(), kamarBattlefieldReward, instance.getPlayersInside(), true));
            	PacketSendUtility.sendPacket(player, new SM_INSTANCE_SCORE(5, getTime(), kamarBattlefieldReward, player.getObjectId()));
            }
        });
    }
	...
	public void sendNpcScorePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(11, getTime(), kamarBattlefieldReward, player.getObjectId()));
            }
        });
    }
	public void sendPlayerLeavePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(8, getTime(), kamarBattlefieldReward, player.getObjectId()));
            }
        });
    }
	public void sendPlayerDiePacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(4, getTime(), kamarBattlefieldReward, player.getObjectId(), 60, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(3, getTime(), kamarBattlefieldReward, player.getObjectId(), 60, player.getRace().getRaceId()));
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(7, getTime(), kamarBattlefieldReward, instance.getPlayersInside(), true));
            }
        });
    }
	public void sendPlayerRevivedPacket(final Player player) {
    	instance.doOnAllPlayers(new Visitor<Player>() {
            @Override
            public void visit(Player GroupMember) {
            	PacketSendUtility.sendPacket(GroupMember, new SM_INSTANCE_SCORE(4, getTime(), kamarBattlefieldReward, player.getObjectId(), 0, player.getRace().getRaceId()));
            }
        });
    }
    ...
    public void onInstanceCreate(WorldMapInstance instance) {
		...
		switch (Rnd.get(1, 7)) {
			...
			break;
			case 3:
				spawn(801903, 1138.9729f, 1619.5848f, 598.4350f, (byte) 53);
			break;
			case 4:
				spawn(801903, 1270.4344f, 1455.3026f, 595.2920f, (byte) 21);
			break;
			case 5:
				spawn(801903, 1347.4727f, 1717.1498f, 598.4339f, (byte) 21);
			break;
			case 6:
				spawn(801903, 1393.9829f, 1358.7335f, 598.6061f, (byte) 117);
			break;
			case 7:
				spawn(801903, 1324.5284f, 1554.0479f, 595.5000f, (byte) 95);
			break;
		}
    }
    ...
    protected void reward() {
        ...
        for (Player player: instance.getPlayersInside()) {
			...
			if (player.getRace().equals(kamarBattlefieldReward.getWinnerRace())) {
				...
				playerReward.setKamarStigmaBox(188071860);
			} else {
			    ...
			    playerReward.setAdditionalReward(152080094);
				playerReward.setAdditionalReward(152080095);
				ItemService.addItem(player, 152080094, 10);
				ItemService.addItem(player, 152080095, 10);
			}
			ItemService.addItem(player, 188071860, 1);
	...
	public void onDie(Npc npc) {
        ...
        switch (npc.getNpcId()) {
			...
			case 801773: //Fuel Barrel.
			    score += 75;
				despawnNpc(npc);
				ItemService.addItem(mostPlayerDamage, 164000262, 1); //Siege's Power.
            break;
		...
		switch (npc.getNpcId()) {
			...
			case 701912: //Kamar Tank Elyos.
				if (player.isTransformed()) {
					...
					despawnNpc(npc);
					SkillEngine.getInstance().applyEffectDirectly(21403, player, player, 3600000 * 1);
				}
			break;
			...
			case 701911: //Kamar Tank Asmodians.
			    if (player.isTransformed()) {
					...
					despawnNpc(npc);
					SkillEngine.getInstance().applyEffectDirectly(21404, player, player, 3600000 * 1);
				}
			break;
            ...
            case 701902: //Kamar Cannon.
                if (player.isTransformed()) {
					...
					despawnNpc(npc);
					SkillEngine.getInstance().applyEffectDirectly(21409, player, player, 3600000 * 1);
				}
            break;
        }
