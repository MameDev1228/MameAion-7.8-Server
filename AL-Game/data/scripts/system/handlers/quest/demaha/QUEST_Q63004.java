...
public class QUEST_Q63004 extends QuestHandler
{
	...
	public void register() {
		qe.registerQuestItem(182216796, questId);
			...
			if (targetId == 820395) {
				switch (env.getDialog()) {
					case START_DIALOG: {
						...
						giveQuestItem(env, 182216796, 1);
						giveQuestItem(env, 182216797, 1);
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						updateQuestStatus(env);
						removeQuestItem(env, 182216797, 1);
						return closeDialogWindow(env);
					}
                }
            }
