...
public class Hamerun_The_BleederAI2 extends AggressiveNpcAI2
{
	...
	private void chooseAttack() {
		switch (Rnd.get(1, 2)) {
			...
			break;
			case 2:
			    brainwashedMumuFighter();
			break;
		}
	}
	
	private void brainwashedFighter() {
		if (getPosition().getWorldMapInstance().getNpc(282041) == null &&
		    getPosition().getWorldMapInstance().getNpc(282042) == null) {
			rndSpawn(282041, 1);
		}
	}
	private void brainwashedMumuFighter() {
		if (getPosition().getWorldMapInstance().getNpc(282041) == null &&
		    getPosition().getWorldMapInstance().getNpc(282042) == null) {
			rndSpawn(282042, 1);
		}
	...
	protected void handleDied() {
		...
		sendMsg(342400, getObjectId(), false, 0);
