...
public class QUEST_Q62820 extends QuestHandler
{
	private final static int questId = 62820;
	private final static int[] BIDLDF8_LAB_Boss_04_80_Ah = {858115, 858277};
	...
	public void register() {
		...
		qe.registerQuestItem(182216849, questId);
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 838047) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182216850, 1);
