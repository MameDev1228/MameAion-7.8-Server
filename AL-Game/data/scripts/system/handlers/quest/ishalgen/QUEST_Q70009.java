...
public class QUEST_Q70009 extends QuestHandler
{
	private final static int questId = 70009;
	private final static int[] npcs = {703488, 799524, 806814, 806883};
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 70008, true);
    }
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						if (QuestService.collectItemCheck(env, true)) {
							...
							removeQuestItem(env, 182216581, 3);
