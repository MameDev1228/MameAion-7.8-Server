...
@AIName("Contaminated_Pool")
public class Contaminated_PoolAI2 extends NpcAI2
{
	@Override
	public void think() {
	}
	...
	private void checkDistance(Creature creature) {
		...
		int skill = 0;
		switch (owner) {
			case 858282: //Contaminated Pool.
				skill = 20554;
			break;
		} if (creature instanceof Player) {
			if (getNpcId() == 858282 && MathUtil.isIn3dRangeLimited(getOwner(), creature, 1, 8)) {
