...
@AIName("IDBattleChange_Polymorph_Ch")
public class IDBattleChange_Polymorph_ChAI2 extends NpcAI2
{
	@Override
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (dialogId == 10000) {
			switch (getNpcId()) {
			    case 656698: //IDBattleChange_Polymorph_Ch_NPC_Li.
				    if (player.getCommonData().getRace() == Race.ELYOS) {
						...
						player.getSkillList().addSkill(player, 5241, 1);
						player.getSkillList().addSkill(player, 5244, 1);
						player.getSkillList().addSkill(player, 5247, 1);
						player.getSkillList().addSkill(player, 5249, 1);
						player.getSkillList().addSkill(player, 5250, 1);
						//Kn
					    ...
					    SkillEngine.getInstance().applyEffectDirectly(20314, player, player, 1800000 * 1);
					}
			    break;
				case 656701: //IDBattleChange_Polymorph_Ch_NPC_Da.
				    if (player.getCommonData().getRace() == Race.ASMODIANS) {
						...
						SkillLearnService.removeSkill(player, 5238);
						SkillLearnService.removeSkill(player, 5322);
					    SkillEngine.getInstance().applyEffectDirectly(20320, player, player, 1800000 * 1);
					}
			    break;
			}
		}
