...
public class AddTitle extends AdminCommand
{
	...
	public void execute(Player player, String... params) {
		...
		if ((titleId > 495) || (titleId < 1)) {
			PacketSendUtility.sendMessage(player, "title id " + titleId + " is invalid (must be between 1 and 496)");
			return;
		}
		Player target = null;
		if (params.length == 2) {
			...
			titleId = target.getRace().getRaceId() * 495 + titleId;
