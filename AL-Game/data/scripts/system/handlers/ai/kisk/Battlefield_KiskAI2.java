...
@AIName("Battlefield_Kisk")
public class Battlefield_KiskAI2 extends NpcAI2
{
	private Future<?> fortifyDefensesTask1;
	private Future<?> fortifyDefensesTask2;
	private Future<?> fortifyDefensesTask3;
	...
	protected void handleDespawned() {
		switch (getNpcId()) {
			case 834869:
			case 834872:
			    fortifyDefensesTask1.cancel(true);
			break;
			case 834870:
			case 834873:
			    fortifyDefensesTask2.cancel(true);
			break;
			case 834871:
			case 834874:
			    fortifyDefensesTask3.cancel(true);
			break;
		}
	...
	private void fortifyDefenses1() {
		fortifyDefensesTask1 = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				AI2Actions.useSkill(Battlefield_KiskAI2.this, 17616); //Fortify Defenses.
			}
		}, 1000, 60000);
	}
	private void fortifyDefenses2() {
		fortifyDefensesTask2 = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				AI2Actions.useSkill(Battlefield_KiskAI2.this, 17617); //Fortify Defenses.
			}
		}, 1000, 60000);
	}
	private void fortifyDefenses3() {
		fortifyDefensesTask3 = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				AI2Actions.useSkill(Battlefield_KiskAI2.this, 17618); //Fortify Defenses.
			}
		}, 1000, 60000);
	}
