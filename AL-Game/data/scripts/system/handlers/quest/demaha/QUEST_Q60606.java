...
public class QUEST_Q60606 extends QuestHandler
{
	private final static int questId = 60606;
	private final static int[] npcs = {806997, 820519, 820522, 731947};
	...
	public void register() {
		...
		qe.registerQuestItem(182216931, questId);
			...
			if (targetId == 806997) {
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						removeQuestItem(env, 182216931, 1);
						return closeDialogWindow(env);
					}
                }
            }
