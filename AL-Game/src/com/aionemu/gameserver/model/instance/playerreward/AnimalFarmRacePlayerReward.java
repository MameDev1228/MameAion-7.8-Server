...
public class AnimalFarmRacePlayerReward extends InstancePlayerReward
{
    private Race race;
	...
	private int commonTreasureChestKey;
	
    public AnimalFarmRacePlayerReward(Integer object, int timeBonus, byte buffId, Race race) {
        super(object);
	...
	public int getCommonTreasureChestKey() {
        return commonTreasureChestKey;
    }
	public void setCommonTreasureChestKey(int reward) {
        this.commonTreasureChestKey = reward;
    }
