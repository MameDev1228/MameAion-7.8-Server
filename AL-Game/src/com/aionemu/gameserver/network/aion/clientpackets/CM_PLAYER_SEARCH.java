...
public class CM_PLAYER_SEARCH extends AionClientPacket
{
	...
	protected void runImpl() {
		...
		if (activePlayer.getLevel() < 5) {
			//Characters under level 5 cannot use the search function.
			PacketSendUtility.sendPacket(activePlayer, SM_SYSTEM_MESSAGE.STR_CANT_WHO_LEVEL("5"));
			return;
