...
public class Esoterrace_WindStream_1AI2 extends NpcAI2
{
	...
	private void startWindStream(final Npc npc) {
        ThreadPoolManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                Npc npc2 = (Npc) spawn(300250000, 703053, 392.0000f, 543.0000f, 318.0000f, (byte) 18, 0, 1);
				windStreamAnnounce(npc2, 1);
				WorldMapInstance instance = getPosition().getWorldMapInstance();
				deleteNpcs(instance.getNpcs(703052));
                spawn(703053, 392.0000f, 543.0000f, 318.0000f, (byte) 18);
