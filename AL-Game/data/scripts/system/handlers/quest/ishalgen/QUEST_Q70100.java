...
public class QUEST_Q70100 extends QuestHandler
{
	private final static int questId = 70100;
	private final static int[] npcs = {204075, 204182, 730268, 798800};
	...
	public void register() {
		...
		qe.registerOnMovieEndQuest(122, questId);
            ...
            if (targetId == 204182) {
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						TeleportService2.teleportTo(env.getPlayer(), 120020000, 1563.0000f, 1424.0000f, 266.0000f, (byte) 0);
						return closeDialogWindow(env);
					}
                }
            }
