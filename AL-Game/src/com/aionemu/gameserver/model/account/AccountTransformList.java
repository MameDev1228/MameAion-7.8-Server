...
public class AccountTransformList {
    ...
    private Map<Integer, AccountTransfo> transformations = new FastMap<Integer, AccountTransfo>();
    private Map<Integer, AccountTransfo> transformationsCreated = new FastMap<Integer, AccountTransfo>();

    public AccountTransformList(final Player player) {
        this.player = player;
