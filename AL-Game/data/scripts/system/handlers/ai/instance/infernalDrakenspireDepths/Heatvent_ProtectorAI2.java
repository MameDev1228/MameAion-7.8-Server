...
public class Heatvent_ProtectorAI2 extends AggressiveNpcAI2
{
	...
	private void shareSource() {
	    SkillEngine.getInstance().getSkill(getOwner(), 20770, 60, getOwner()).useNoAnimationSkill(); //Heatvent Protector.
	...
	private void tornado() {
		//Engulf them! Fire storm!
		sendMsg(1501213, getObjectId(), false, 0);
		//Show your true selve, my minions!
		sendMsg(1501214, getObjectId(), false, 3000);
		if (getPosition().getWorldMapInstance().getNpc(855625) == null &&
		    getPosition().getWorldMapInstance().getNpc(855622) == null) {
			//Raging Hellfire.
	...
	private void flamekiteGeist() {
		...
		//Show your true selve, my minions!
		sendMsg(1501214, getObjectId(), false, 3000);
		if (getPosition().getWorldMapInstance().getNpc(855622) == null &&
		    getPosition().getWorldMapInstance().getNpc(855625) == null) {
			//Raging Hellfire.
			AI2Actions.useSkill(this, 21645);
			rndSpawn(855622, 3);
		}
	...
	protected void handleBackHome() {
		...
		deleteNpcs(instance.getNpcs(855622));
		killNpc(instance.getNpcs(855625));
	}
	...
	protected void handleDied() {
		super.handleDied();
		cancelTask();
		//I now return to the Locus.
		sendMsg(1501216, getObjectId(), false, 0);
