...
@AIName("DF4_3011_Boss_Dr_1")
public class DF4_3011_Boss_Dr_1AI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc siegeGate1 = getPosition().getWorldMapInstance().getNpc(257794);
				Npc siegeGate2 = getPosition().getWorldMapInstance().getNpc(257841);
