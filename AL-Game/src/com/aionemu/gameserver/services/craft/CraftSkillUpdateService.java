...
public class CraftSkillUpdateService
{
	...
	public void setMorphRecipe(Player player) {
		...
		if (player.getLevel() == 76) {
			...
			if (!recipelist.isRecipePresent(155204731)) { //Morph: Legendary PvE Enchantment Stone 1
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204731);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204731));
			} if (!recipelist.isRecipePresent(155204732)) { //Morph: Legendary PvE Enchantment Stone 2
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204732);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204732));
			} if (!recipelist.isRecipePresent(155204733)) { //Morph: Ultimate PvE Enchantment Stone 1
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204733);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204733));
			} if (!recipelist.isRecipePresent(155204734)) { //Morph: Ultimate PvE Enchantment Stone 2
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204734);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204734));
			} if (!recipelist.isRecipePresent(155204735)) { //Morph: Legendary PvP Enchantment Stone 1
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204735);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204735));
			} if (!recipelist.isRecipePresent(155204736)) { //Morph: Legendary PvP Enchantment Stone 2
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204736);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204736));
			} if (!recipelist.isRecipePresent(155204737)) { //Morph: Ultimate PvP Enchantment Stone 1
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204737);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204737));
			} if (!recipelist.isRecipePresent(155204738)) { //Morph: Ultimate PvP Enchantment Stone 2
				DAOManager.getDAO(PlayerRecipesDAO.class).addRecipe(object, 155204738);
				PacketSendUtility.sendPacket(player, new SM_LEARN_RECIPE(155204738));
			}
		}
	}
