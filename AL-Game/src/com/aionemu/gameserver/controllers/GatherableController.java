...
public class GatherableController extends VisibleObjectController<Gatherable>
{
	...
	public void rewardPlayer(Player player) {
		if (player != null) {
			//Essencetapping < 499Pts.
			if (player.getSkillList().getSkillLevel(30002) != 499) {
				player.getSkillList().addSkill(player, 30002, player.getSkillList().getSkillLevel(30002) + 1);
				player.getCommonData().addExp(Rnd.get(200000, 250000), RewardType.GATHERING, this.getOwner().getObjectTemplate().getNameId());
			}
			//Essencetapping >= 499Pts.
			if (player.getSkillList().getSkillLevel(30002) >= 499) {
				player.getCommonData().addExp(Rnd.get(200000, 250000), RewardType.GATHERING, this.getOwner().getObjectTemplate().getNameId());
