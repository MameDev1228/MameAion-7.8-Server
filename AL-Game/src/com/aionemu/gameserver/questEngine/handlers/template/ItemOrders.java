...
public class ItemOrders extends QuestHandler
{
    ...
    public boolean onDialogEvent(QuestEnv env) {
		...
		if (env.getVisibleObject() instanceof Npc) {
            ...
            if (env.getDialogId() == 1002 || env.getDialogId() == 20000) {
                QuestService.startQuest(env);
                PacketSendUtility.sendPacket(player, new SM_DIALOG_WINDOW(0, 0));
                return true;
            } else if (env.getDialogId() == 1003 || env.getDialogId() == 20001) {
            ...
            if (qs != null) {
                ...
                } else if (env.getDialogId() == 1009 && env.getDialogId() == 1010 && qs.getStatus() != QuestStatus.COMPLETE && qs.getStatus() != QuestStatus.NONE) {
