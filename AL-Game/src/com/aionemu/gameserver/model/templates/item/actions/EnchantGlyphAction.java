...
public class EnchantGlyphAction extends AbstractItemAction
{
    ...
    public boolean canAct(Player player, Item parentItem, Item targetItem) {
        if (parentItem == null || targetItem == null) {
            ...
            return false;
        } if (parentItem.getItemTemplate().isGlyphEnchant() && player.getInventory().getKinah() < EnchantService.EnchantKinah(targetItem)) {
    ...
    public void act(final Player player, final Item parentItem, final Item targetItem) {
        ...
        player.getController().addTask(TaskId.ITEM_USE, ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                EnchantService.enchantGlyphItemAct(player, parentItem, targetItem, targetItem.getEnchantPvPvELevel(), isSuccess);
