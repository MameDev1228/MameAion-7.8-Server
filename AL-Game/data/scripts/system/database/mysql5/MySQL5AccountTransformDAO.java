...
public class MySQL5AccountTransformDAO extends AccountTransformDAO
{
    ...
    private static final String INSERT_QUERY = "INSERT INTO `account_transform`(`account_id`,`card_id`, `count`) VALUES (?,?,?) ON DUPLICATE KEY UPDATE `count` = GREATEST(`count`, VALUES(`count`))";
