...
public class PlayerInitialData {
	...
	@XmlElement(name = "elyos_jumping_location", required = true)
	private LocationData elyosJumpingSpawnLocation;
	@XmlElement(name = "asmodian_jumping_location", required = true)
	private LocationData asmodianJumpingSpawnLocation;
	...
	public LocationData getJumpingSpawnLocation(Race race) {
		switch (race) {
			case ASMODIANS:
				return asmodianJumpingSpawnLocation;
			case ELYOS:
				return elyosJumpingSpawnLocation;
			default:
				throw new IllegalArgumentException();
		}
	}
