...
public class StatCapUtil
{
    ...
    public static int getLowerCap(StatEnum stat) {
        ...
        switch (stat) {
			...
			case PVE_POWER_BOOST_RESIST:
			case PVP_POWER_BOOST_RESIST:
			case PHYSICAL_DAMAGE_BOOST_RESIST:
			case MAGICAL_DAMAGE_BOOST_RESIST:
    ...
    public static int getUpperCap(StatEnum stat) {
        ...
        switch (stat) {
			...
			case PHYSICAL_DAMAGE_BOOST:
			case MAGICAL_DAMAGE_BOOST:
