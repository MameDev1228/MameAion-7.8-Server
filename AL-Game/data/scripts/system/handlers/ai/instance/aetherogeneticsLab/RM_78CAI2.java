 ...
 */
package ai.instance.aetherogeneticsLab;
...
@AIName("RM_78C")
public class RM_78CAI2 extends AggressiveNpcAI2
{
	...
	private void strangeCreature() {
		...
		sendMsg(341534, getObjectId(), false, 8000);
		if (getPosition().getWorldMapInstance().getNpc(280790) == null) {
			rndSpawn(280790, 2);
		}
	}
	...
	protected void handleBackHome() {
		...
		killNpc(instance.getNpcs(280790));
	}
