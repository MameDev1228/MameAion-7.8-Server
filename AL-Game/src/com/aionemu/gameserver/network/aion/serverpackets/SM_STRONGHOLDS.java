...
public class SM_STRONGHOLDS extends AionServerPacket {

    private static final Logger log = LoggerFactory.getLogger(SM_STRONGHOLDS.class);
    private Map<Integer, SiegeLocation> locations;

    public SM_STRONGHOLDS(SiegeLocation loc) {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        for (SiegeLocation loc : locations.values()) {
            ...
            writeD(0);
            writeD(0);
            writeS("[SAVE]Special"+loc.getLocationId(), 64);
            writeS("[SAVE]Reward"+loc.getLocationId()+"_05", 64);
        }
    }
}
