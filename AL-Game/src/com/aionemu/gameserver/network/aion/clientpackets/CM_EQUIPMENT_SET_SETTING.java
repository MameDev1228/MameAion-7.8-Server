...
public class CM_EQUIPMENT_SET_SETTING extends AionClientPacket
{
    private static final Logger log = LoggerFactory.getLogger(CM_EQUIPMENT_SET_SETTING.class);
    private int slot;
    ...
    public CM_EQUIPMENT_SET_SETTING(int opcode, AionConnection.State state, AionConnection.State... restStates) {
