...
public class QUEST_Q61600 extends QuestHandler
{
	private final static int questId = 61600;
	
	private String[] rings = {"HEIRON_AIR_BOOSTER_1", "HEIRON_AIR_BOOSTER_2", "HEIRON_AIR_BOOSTER_3",
	"HEIRON_AIR_BOOSTER_4", "HEIRON_AIR_BOOSTER_5", "HEIRON_AIR_BOOSTER_6"};
	...
	public void register() {
		...
		qe.registerQuestNpc(204505).addOnQuestStart(questId);
		qe.registerQuestNpc(204505).addOnTalkEvent(questId);
		qe.registerQuestNpc(203930).addOnTalkEvent(questId);
		qe.registerQuestNpc(204513).addOnTalkEvent(questId);
	}
			...
			if (targetId == 204505) {
				switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						TeleportService2.teleportTo(player, 210040000, 2509.0000f, 415.0000f, 441.0000f, (byte) 0);
