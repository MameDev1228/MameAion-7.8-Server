...
@AIName("IDBattleChange_Polymorph_Kn")
public class IDBattleChange_Polymorph_KnAI2 extends NpcAI2
{
	@Override
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (dialogId == 10000) {
			switch (getNpcId()) {
			    case 656668: //IDBattleChange_Polymorph_Kn_NPC_Li.
				    if (player.getCommonData().getRace() == Race.ELYOS) {
						...
						player.getSkillList().addSkill(player, 5181, 1);
						player.getSkillList().addSkill(player, 5187, 1);
						player.getSkillList().addSkill(player, 5184, 1);
						player.getSkillList().addSkill(player, 5189, 1);
						player.getSkillList().addSkill(player, 5190, 1);
						//Fi
					    ...
					    SkillEngine.getInstance().applyEffectDirectly(20309, player, player, 1800000 * 1);
					}
			    break;
				case 656671: //IDBattleChange_Polymorph_Kn_NPC_Da.
				    if (player.getCommonData().getRace() == Race.ASMODIANS) {
						...
						SkillLearnService.removeSkill(player, 5249);
						SkillLearnService.removeSkill(player, 5250);
					    SkillEngine.getInstance().applyEffectDirectly(20315, player, player, 1800000 * 1);
					}
			    break;
			}
		}
