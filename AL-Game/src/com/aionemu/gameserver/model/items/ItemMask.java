...
public class ItemMask
{
	...
	public static final int CAN_VENDOR = (1 << 20);
    public static final int CANNOT_EXTRACTION = (1 << 21);
    public static final int CANNOT_MATTER_OPTIONS = (1 << 22);
    public static final int CAN_DECOMPOSABLE = (1 << 23);
}