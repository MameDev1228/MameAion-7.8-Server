...
public class QUEST_Q72905 extends QuestHandler
{
	private final static int questId = 72905;
	...
	public void register() {
		qe.registerQuestItem(182216900, questId);
		...
		if (qs == null || qs.getStatus() == QuestStatus.START) {
            ...
            if (targetId == 820393) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
					...
					removeQuestItem(env, 182216900, 1);
					removeQuestItem(env, 182216908, 2);
