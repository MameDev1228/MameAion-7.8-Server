...
@AIName("IDBattleChange_Polymorph_Fi")
public class IDBattleChange_Polymorph_FiAI2 extends NpcAI2
{
	@Override
	...
	public boolean onDialogSelect(Player player, int dialogId, int questId, int extendedRewardIndex) {
		...
		if (dialogId == 10000) {
			switch (getNpcId()) {
			    case 656674: //IDBattleChange_Polymorph_Fi_NPC_Li.
				    if (player.getCommonData().getRace() == Race.ELYOS) {
						...
						player.getSkillList().addSkill(player, 5193, 1);
						player.getSkillList().addSkill(player, 5196, 1);
						player.getSkillList().addSkill(player, 5199, 1);
						player.getSkillList().addSkill(player, 5201, 1);
						player.getSkillList().addSkill(player, 5202, 1);
						//Kn
					    ...
					    SkillEngine.getInstance().applyEffectDirectly(20310, player, player, 1800000 * 1);
					}
			    break;
				case 656677: //IDBattleChange_Polymorph_Fi_NPC_Da.
				    if (player.getCommonData().getRace() == Race.ASMODIANS) {
						...
						SkillLearnService.removeSkill(player, 5249);
						SkillLearnService.removeSkill(player, 5250);
					    SkillEngine.getInstance().applyEffectDirectly(20316, player, player, 1800000 * 1);
					}
			    break;
			}
		}
