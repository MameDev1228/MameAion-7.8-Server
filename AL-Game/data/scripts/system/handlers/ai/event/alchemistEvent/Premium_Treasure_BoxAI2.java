...
@AIName("Premium_Treasure_Box")
public class Premium_Treasure_BoxAI2 extends NpcAI2
{
	...
	protected void handleUseItemFinish(Player player) {
		if (!player.getInventory().decreaseByItemId(185000185, 1)) {
			...
			break;
			case 18:
			    ItemService.addItem(player, 188055485, 1); //Luna Wooden Box.
			break;
			case 19:
			    ItemService.addItem(player, 188070328, 1); //Stigma Selection Box.
			break;
			case 20:
