...
public class QUEST_Q1929 extends QuestHandler
{
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 33) {
				qs.setQuestVar(8);
				updateQuestStatus(env);
				TeleportService2.teleportTo(player, 210040000, 2315.9f, 1800.0f, 195.2f, (byte) 0, TeleportAnimation.BEAM_ANIMATION);
				return true;
			}
		}
		return false;
