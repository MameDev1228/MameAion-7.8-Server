...
@XmlType(name = "SkinSkillAction")
public class SkinSkillAction extends AbstractItemAction
{
    ...
    public void act(Player player, Item parentItem, Item targetItem) {
        ...
        for (Integer skin_skill: skinId) {
            player.getSkillSkinList().addSkillSkin(skin_skill, minutes * 60, expireTime);
        }
