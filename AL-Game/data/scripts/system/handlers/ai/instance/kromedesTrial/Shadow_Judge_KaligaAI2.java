...
public class Shadow_Judge_KaligaAI2 extends AggressiveNpcAI2
{
	...
	private void relicEffect() {
		if (getNpcId() == 653367 || getNpcId() == 656254) {
			...
			getSpawnTemplate().setWalkerId("Shadow_Judge_Kaliga");
    ...
    protected void handleMoveArrived() {
		...
		if (point == 1) {
			...
			sendMsg(1500159, getObjectId(), false, 0);
	...
	protected void handleDied() {
		...
		sendMsg(342426, getObjectId(), false, 0);
