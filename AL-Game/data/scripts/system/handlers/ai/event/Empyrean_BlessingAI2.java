...
public class Empyrean_BlessingAI2 extends NpcAI2
{
	...
	protected void handleUseItemFinish(Player player) {
		...
		switch (getNpcId()) {
			...
			case 883960: //Harbinger Flight Energy.
                ...
                SkillEngine.getInstance().applyEffectDirectly(22742, player, player, 3600000 * 1);
            break;
			...
			case 883961: //Harbinger Life Energy.
                ...
                SkillEngine.getInstance().applyEffectDirectly(22741, player, player, 3600000 * 1);
            break;
			...
			case 883962: //Harbinger Battle Energy.
				...
				effectController.removeEffect(22741);
				effectController.removeEffect(22742);
                SkillEngine.getInstance().applyEffectDirectly(22740, player, player, 3600000 * 1);
            break;
			...
			case 883963: //Harbinger Defense Energy.
				...
				effectController.removeEffect(22741);
				effectController.removeEffect(22742);
                SkillEngine.getInstance().applyEffectDirectly(22739, player, player, 3600000 * 1);
            break;
		}
	}
