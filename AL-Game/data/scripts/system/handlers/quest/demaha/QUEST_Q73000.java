...
public class QUEST_Q73000 extends QuestHandler
{
	private final static int questId = 73000;
	private final static int[] LDF8_QuestGuard_Q73000 = {838009, 838010, 838011, 838012, 838013};
	...
	public void register() {
		...
		qe.registerQuestNpc(703770).addOnTalkEvent(questId);
		qe.registerQuestNpc(703771).addOnTalkEvent(questId);
		qe.registerQuestNpc(703772).addOnTalkEvent(questId);
		qe.registerQuestNpc(703773).addOnTalkEvent(questId);
		qe.registerQuestNpc(820406).addOnTalkEvent(questId);
		qe.registerQuestNpc(820440).addOnTalkEvent(questId);
		qe.registerQuestNpc(807023).addOnTalkEvent(questId);
		for (int mob: LDF8_QuestGuard_Q73000) {
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 4) {
                ...
                if (var1 >= 0 && var1 < 2) {
                    return defaultOnKillEvent(env, LDF8_QuestGuard_Q73000, var1, var1 + 1, 1);
                } else if (var1 == 2) {
					qs.setQuestVar(5);
					updateQuestStatus(env);
                    return true;
