...
public class Outpost <OL extends OutpostLocation>
{
    ...
    private final OutpostBossDeathListener outpostBossDeathListener = new OutpostBossDeathListener(this);
	...
	protected void addBaseBossListeners() {
		...
		eo.addCallback(getOutpostBossDeathListener());
	}
	
	protected void rmvBaseBossListener() {
		AbstractAI ai = (AbstractAI) getBoss().getAi2();
		EnhancedObject eo = (EnhancedObject) ai;
		eo.removeCallback(getOutpostBossDeathListener());
	}
    ...
    public OutpostBossDeathListener getOutpostBossDeathListener() {
        return outpostBossDeathListener;
    }
