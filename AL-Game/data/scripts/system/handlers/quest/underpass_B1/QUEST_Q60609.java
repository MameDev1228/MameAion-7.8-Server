...
public class QUEST_Q60609 extends QuestHandler
{
	private final static int questId = 60609;
	...
	public void register() {
		...
		qe.registerQuestItem(182217109, questId);
    ...
    public boolean onLvlUpEvent(QuestEnv env) {
        return defaultOnLvlUpEvent(env, 60608, true);
    }
			...
			if (targetId == 840673) {
                switch (env.getDialog()) {
				    case USE_OBJECT: {
						...
						giveQuestItem(env, 182217109, 1);
                        changeQuestStep(env, 0, 1, false);
						return closeDialogWindow(env);
					} case STEP_TO_4: {
						changeQuestStep(env, 3, 4, false);
						removeQuestItem(env, 182217111, 1);
						removeQuestItem(env, 182217112, 1);
						removeQuestItem(env, 182217113, 1);
						removeQuestItem(env, 182217114, 1);
                ...
                switch (env.getDialog()) {
                    case START_DIALOG: {
						...
						removeQuestItem(env, 182217109, 1);
						return closeDialogWindow(env);
					}
                }
            }
