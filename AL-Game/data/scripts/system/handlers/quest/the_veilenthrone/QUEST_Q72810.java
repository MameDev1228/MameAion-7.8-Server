...
public class QUEST_Q72810 extends QuestHandler
{
	private final static int questId = 72810;
	...
	public void register() {
		qe.registerQuestNpc(836556).addOnQuestStart(questId);
		qe.registerQuestNpc(836556).addOnTalkEvent(questId);
		qe.registerQuestNpc(820177).addOnTalkEvent(questId);
