...
public class QUEST_Q63299 extends QuestHandler
{
	private final static int questId = 63299;
	...
	public void register() {
		...
		qe.registerOnEnterZone(ZoneName.get("LOFTUS_WOODS_800030000"), questId);
		qe.registerOnEnterZone(ZoneName.get("GARREN_FOREST_800030000"), questId);
	}
    ...
    public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
		...
		if (zoneName == ZoneName.get("LOFTUS_WOODS_800030000") || zoneName == ZoneName.get("GARREN_FOREST_800030000")) {
