...
public class LunaConfig
{
    ...
    @Property(key = "gameserver.luna.dice5.fail", defaultValue = "18")
    public static int LUNA_DICE_5_FAIL;
    ...
    @Property(key = "gameserver.luna.dice.rate.2", defaultValue = "50")
    public static int LUNA_DICE_RATE_2;
	
    @Property(key = "gameserver.luna.dice.rate.3", defaultValue = "25")
    public static int LUNA_DICE_RATE_3;
	
    @Property(key = "gameserver.luna.dice.rate.4", defaultValue = "10")
    public static int LUNA_DICE_RATE_4;
	
    @Property(key = "gameserver.luna.dice.rate.5", defaultValue = "5")
    public static int LUNA_DICE_RATE_5;
	
    @Property(key = "gameserver.luna.dice.rate.6", defaultValue = "1")
    public static int LUNA_DICE_RATE_6;
	
    @Property(key = "gameserver.luna.dice.rate.7", defaultValue = "1")
