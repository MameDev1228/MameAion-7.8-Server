...
@AIName("Weakened_Mortasha_Easy")
public class Weakened_Mortasha_EasyAI2 extends AggressiveNpcAI2
{
			...
			public void run() {
				...
				switch (Rnd.get(1, 7)) {
					case 1:
						...
						spawn(858787, 2732.9126f, 2679.0360f, 628.1217f, (byte) 72);
					break;
					case 2:
						scaleshadowPrisonCamp();
						spawn(858787, 2938.8025f, 1910.8958f, 673.2500f, (byte) 92);
					break;
					case 3:
						burningPath();
						spawn(858787, 2585.7322f, 1818.4229f, 695.4014f, (byte) 119);
					break;
					case 4:
						circleOfRebirth();
						spawn(858787, 2765.9385f, 1131.9886f, 777.6271f, (byte) 89);
					break;
					case 5:
						ashwindCliff();
						spawn(858787, 2210.2832f, 1616.7418f, 742.6250f, (byte) 93);
					break;
					case 6:
						yanohasTerritory();
						spawn(858787, 2124.6416f, 2862.5298f, 667.9198f, (byte) 103);
					break;
					case 7:
						boilingGeyser();
						spawn(858787, 2619.9563f, 2220.3723f, 680.8722f, (byte) 33);
					break;
				}
			}
		}, 8000);
