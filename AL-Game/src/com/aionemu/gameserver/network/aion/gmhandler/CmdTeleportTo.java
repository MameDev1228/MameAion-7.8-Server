...
public class CmdTeleportTo extends AbstractGMHandler {
    ...
    public void run() {
        ...
        if (destination.equalsIgnoreCase("Sanctum"))
            ...
            goTo(admin, WorldMapType.CLOISTER_OF_KAISINEL.getId(), 2155, 1567, 1205);
            // Poeta
         ...
         */
            ...
            goTo(admin, WorldMapType.CONVENT_OF_MARCHUTAN.getId(), 1557, 1429, 266);
            // Ishalgen
         ...
         */
            ...
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 951, 936, 1667);
        else if (destination.equalsIgnoreCase("Abyss 1"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 2867, 1034, 1528);
        else if (destination.equalsIgnoreCase("Abyss 2"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 1078, 2839, 1636);
        else if (destination.equalsIgnoreCase("Abyss 3"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 1596, 2952, 2943);
        else if (destination.equalsIgnoreCase("Abyss 4"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 2054, 660, 2843);
        else if (destination.equalsIgnoreCase("Eye of Reshanta") || destination.equalsIgnoreCase("Eye"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 1979, 2114, 2291);
        else if (destination.equalsIgnoreCase("Divine Fortress") || destination.equalsIgnoreCase("Divine"))
            goTo(admin, WorldMapType.ABYSS_CORE.getId(), 2130, 1925, 2322);
