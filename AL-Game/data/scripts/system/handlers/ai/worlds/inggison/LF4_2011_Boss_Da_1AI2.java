...
@AIName("LF4_2011_Boss_Da_1")
public class LF4_2011_Boss_Da_1AI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc siegeGate1 = getPosition().getWorldMapInstance().getNpc(257193);
				Npc siegeGate2 = getPosition().getWorldMapInstance().getNpc(257240);
