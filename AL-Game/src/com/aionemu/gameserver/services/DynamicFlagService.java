...
public class DynamicFlagService
{
    public void onEnterWorld(Player player) {
		if (player.getWorldId() == 210010000) { //Poeta.
        ...
        } if (player.getWorldId() == 210040000) { //Heiron.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 210050000) { //Inggison.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 220010000) { //Ishalgen.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 220040000) { //Beluslan.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 220070000) { //Gelkmaros.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 400070000) { //Abyss Core [Divine Fortress]
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 600010000) { //Silentera Canyon.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 600040000) { //Tiamaranta's Eye.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 800030000) { //Crimson Katalam.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 800040000) { //Crimson Danaria.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 800050000) { //Lakrum.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 800060000) { //Demaha.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
        ...
        } if (player.getWorldId() == 800070000) { //Underpass B1.
            World.getInstance().getWorldMap(player.getWorldId()).getMainWorldMapInstance().doOnAllPlayers(new Visitor<Player>() {
                public void visit(Player player) {
                    for (VisibleObject npc: World.getInstance().getNpcs()) {
    ...
    public static DynamicFlagService getInstance() {
        return DynamicFlagServiceHolder.INSTANCE;
    }
	
    private static class DynamicFlagServiceHolder {
        private static final DynamicFlagService INSTANCE = new DynamicFlagService();
    }
}