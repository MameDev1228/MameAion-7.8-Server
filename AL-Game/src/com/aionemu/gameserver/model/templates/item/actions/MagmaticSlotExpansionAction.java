...
@XmlType(name = "MagmaticSlotExpansionAction")
public class MagmaticSlotExpansionAction extends AbstractItemAction
{
    @Override
        ...
        player.getController().addTask(TaskId.ITEM_USE, ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
				if (isSlotSuccess) {
					...
					//%0's Manastone slot expansion was successful. 1 slot was added.
					...
					player.getObserveController().removeObserver(moveObserver);
					//%0's Manastone slot expansion failed.
