...
public class QUEST_Q70000 extends QuestHandler
{
	private final static int questId = 70000;
	private final static int[] npcs = {203550, 806810};
		...
		if (qs == null || qs.getStatus() == QuestStatus.START) {
            ...
            if (targetId == 203550) {
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    ...
                    int[] ishalgenMission = {70001, 70002, 70003, 70004, 70005, 70006, 70007, 70008, 70009};
    ...
    public boolean onEnterZoneEvent(QuestEnv env, ZoneName zoneName) {
        Player player = env.getPlayer();
        QuestState qs = player.getQuestStateList().getQuestState(questId);
		if (zoneName == ZoneName.get("ALDELLE_VILLAGE_220010000")) {
			if (qs == null) {
