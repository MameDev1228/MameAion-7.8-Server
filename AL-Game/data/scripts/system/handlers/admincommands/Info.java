...
public class Info extends AdminCommand
{
	...
	public void execute(Player admin, String... params) {
		...
		if (target instanceof Player) {
			...
			+ "\nPvE Power Boost: " + player.getGameStats().getStat(StatEnum.PVE_POWER_BOOST, 0).getCurrent() * 0.1f + "%"
			+ "\nPvP Power Boost: " + player.getGameStats().getStat(StatEnum.PVP_POWER_BOOST, 0).getCurrent() * 0.1f + "%"
			+ "\nPvE Power Boost Resist: " + player.getGameStats().getStat(StatEnum.PVE_POWER_BOOST_RESIST, 0).getCurrent() * 0.1f + "%"
			+ "\nPvP Power Boost Resist: " + player.getGameStats().getStat(StatEnum.PVP_POWER_BOOST_RESIST, 0).getCurrent() * 0.1f + "%"
			...
			+ "\nAccuracy: " + player.getGameStats().getPAccuracy().getCurrent()
			+ "\nCritical: " + player.getGameStats().getPCritical().getCurrent()
