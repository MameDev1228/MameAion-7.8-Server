...
public class Castle_GateAI2 extends NpcAI2
{
	...
	private void moveToAcross(Player responder) {
		...
		PacketSendUtility.broadcastPacketAndReceive(responder, new SM_TRANSFORM(responder, responder.getTransformedModelId(), true, responder.getTransformedItemId(), responder.getTransformedSkillId()));
