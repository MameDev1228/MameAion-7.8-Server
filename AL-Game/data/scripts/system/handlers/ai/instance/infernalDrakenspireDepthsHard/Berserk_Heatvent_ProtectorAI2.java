...
@AIName("Berserk_Heatvent_Protector")
public class Berserk_Heatvent_ProtectorAI2 extends AggressiveNpcAI2
{
		...
		for (Integer percent: percents) {
			if (hpPercentage <= percent) {
				switch (percent) {
					case 40:
					case 10:
					    spawn(858683, 530.8853f, 165.2495f, 1681.8225f, (byte) 90); //IDSeal_Hard_Portal_01.
						ThreadPoolManager.getInstance().schedule(new Runnable() {
							@Override
							public void run() {
								WorldMapInstance instance = getPosition().getWorldMapInstance();
								deleteNpcs(instance.getNpcs(858683));
							}
						}, 90000);
					break;
				}
	...
	protected void handleDied() {
		...
		spawn(858803, 530.6876f, 152.1096f, 1681.8224f, (byte) 1); //Twin Source.
		spawn(858683, 530.8853f, 165.2495f, 1681.8225f, (byte) 90); //IDSeal_Hard_Portal_01.
		WorldMapInstance instance = getPosition().getWorldMapInstance();
		killNpc(instance.getNpcs(858686));
		killNpc(instance.getNpcs(858687));
