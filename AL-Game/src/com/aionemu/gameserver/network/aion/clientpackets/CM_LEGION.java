			...
			if (charName != null) {
				...
				switch (exOpcode) {
					...
					case 0x13:
                        ...
                        break;
                    case 0x14:
                    	    LegionService.getInstance().handleJoinRequestAcceptAnswer(activePlayer, playerId);
                        break;
                    case 0x15:
                		    LegionService.getInstance().handleJoinRequesDeclineAnswer(activePlayer, playerId);
                        break;
					/** Misc. **/
					default:
