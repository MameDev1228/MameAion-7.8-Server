...
public class Effects
{
	@XmlElements({
		...
		@XmlElement(name = "petrification2", type = PetrificationEffect2.class),
		@XmlElement(name = "targetchannelling", type = TargetChannellingEffect.class),
		@XmlElement(name = "summonchannellingarea", type = SummonChannellingAreaEffect.class),
		@XmlElement(name = "healandfireonzerohp", type = HealAndFireOnZeroHpEffect.class),
		@XmlElement(name = "skillatkdrain", type = SkillAtkDrainEffect.class),
		@XmlElement(name = "intervalskill", type = IntervalSkillEffect.class),
		@XmlElement(name = "worldplaytime", type = WorldPlayTimeEffect.class),
		@XmlElement(name = "alwayshit", type = AlwaysHitEffect.class),
		@XmlElement(name = "alwaysnoresist", type = AlwaysNoResistEffect.class),
		@XmlElement(name = "onetimegetboosteddamage", type = OneTimeGetBoostedDamageEffect.class),
