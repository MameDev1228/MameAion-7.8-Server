...
@AIName("Berserk_Beritra")
public class Berserk_BeritraAI2 extends AggressiveNpcAI2
{
					...
					case 40:
						...
						ThreadPoolManager.getInstance().schedule(new Runnable() {
							...
							public void run() {
								...
								spawn(858972, 127.0000f, 508.0000f, 1749.0000f, (byte) 8); //Berserk Beritra [Dragon Form].
