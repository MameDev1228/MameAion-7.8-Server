...
@AIName("DF4_3021_Boss_Li_1")
public class DF4_3021_Boss_Li_1AI2 extends AggressiveNpcAI2
{
	...
	private void checkTurningTide() {
		checkTask = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
			@Override
			public void run() {
				Npc siegeGate1 = getPosition().getWorldMapInstance().getNpc(258092);
				Npc siegeGate2 = getPosition().getWorldMapInstance().getNpc(258139);
