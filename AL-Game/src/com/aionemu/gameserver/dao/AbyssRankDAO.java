...
public abstract class AbyssRankDAO implements DAO
{
    ...
    public abstract Map<Integer, AbyssRankUpdateService.PlayerGPMapping> loadPlayersGp();
    public abstract void updateDailyGpPlayer(int playerId, int gp);
	...
	public abstract void onDailtResetGP(String request);
}