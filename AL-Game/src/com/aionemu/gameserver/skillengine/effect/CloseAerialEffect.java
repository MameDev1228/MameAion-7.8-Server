...
public class CloseAerialEffect extends EffectTemplate
{
	...
	public void applyEffect(Effect effect) {
		...
		effect.getEffected().getEffectController().removeEffect(9220);
		effect.getEffected().getEffectController().removeEffect(9317);
		effect.getEffected().getEffectController().removeEffect(9338);
		effect.getEffected().getEffectController().removeEffect(9380);
		effect.getEffected().getEffectController().removeEffect(9404);
	}
