...
@InstanceID(302600000)
public class IDTM_Lobby_3Vs3 extends GeneralInstanceHandler
{
	...
	private Logger log = LoggerFactory.getLogger(IDTM_Lobby_3Vs3.class);
    	...
    	hotTask.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                if (!instanceReward.isRewarded()) {
                	...
                	instanceReward.setCoupleSlotForBattle8();
