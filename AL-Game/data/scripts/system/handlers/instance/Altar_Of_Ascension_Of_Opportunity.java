...
@InstanceID(302830000)
public class Altar_Of_Ascension_Of_Opportunity extends GeneralInstanceHandler
{
    ...
    public void onInstanceCreate(WorldMapInstance instance) {
		...
		//Complete the raid as quickly as possible to obtain an additional Altar of Ascension of Opportunity Reward Box.
		sendMsgByRace(1405941, Race.PC_ALL, 17000);
