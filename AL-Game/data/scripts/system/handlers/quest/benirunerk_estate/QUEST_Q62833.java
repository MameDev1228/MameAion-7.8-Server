...
public class QUEST_Q62833 extends QuestHandler
{
	private final static int questId = 62833;
	private final static int[] IDF8_House_MiniRider_80 = {858512};
	...
	public void register() {
		for (int mob: IDF8_House_MiniRider_80) {
	...
	public boolean onKillEvent(QuestEnv env) {
		...
		if (qs != null && qs.getStatus() == QuestStatus.START) {
			...
			if (var == 0) {
                ...
                if (var1 >= 0 && var1 < 0) {
                    return defaultOnKillEvent(env, IDF8_House_MiniRider_80, var1, var1 + 1, 1);
                } else if (var1 == 0) {
					qs.setQuestVar(1);
